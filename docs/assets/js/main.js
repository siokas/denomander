!function (e, t) {
  ...
  k.fn.extend({
    ...
    index: function (e) {
      return e
        ? "string" == typeof e ? i.call(k(e), this[0]) : i.call(
          this,
          e.jquery ? e[0] : e,
        )
  ...
  var _ = function (e, t, n, r, i, o, a) {
      ...
      if ("object" === w(n)) for (s in i = !0, n) _(e, t, s, n[s], !0, o, a);
        ...
        void 0 !== r && (i = !0,
          m(r) || (a = !0),
          l && (t = a ? (t.call(e, r), null) : (l = t, function (e, t, n) {
            return l.call(k(e), n);
          })),
          t)
      ) {
    ...
    k.fn.extend({
      queue: function (t, n) {
        ...
        return "string" != typeof t && (n = t, t = "fx", e--),
          arguments.length < e ? k.queue(this[0], t) : void 0 === n
          ? this
          : this.each(function () {
    ...
    k.extend({
      ...
      attrHooks: {
        type: {
          set: function (e, t) {
            if (
              !y.radioValue && "radio" === t && A(e, "input")
            ) {
              var n = e.value;
              ...
              (h = !0,
                ...
                i
                  ? (v.ifModified &&
                    ...
                    204 === e || "HEAD" === v.type ? l = "nocontent" : 304 === e
                    ? l = "notmodified"
  ...
  function () {
    ...
    function d(n, r, t) {
      return h.iteratee !== v ? h.iteratee(n, r)
      : null == n ? h.identity
      : h.isFunction(n)
      ? y(n, r, t)
    ...
    h.toArray = function (n) {
      return n
        ? h.isArray(n) ? c.call(n) : h.isString(n) ? n.match(S) : w(n)
        ? h.map(n, h.identity)
        : h.values(n)
        : [];
    },
      ...
      h.last = function (n, r, t) {
        return null == n || n.length < 1 ? null == r ? void 0 : []
    ...
    h.flatten = function (n, r) {
      ...
      h.uniq = h.unique = function (n, r, t, e) {
        ...
        for (var u = [], i = [], o = 0, a = A(n); o < a; o++) {
          ...
          r && !t ? (o && i === l || u.push(c), i = l)
          : t ? h.contains(i, l) || (i.push(l), u.push(c))
  ...
  function (t) {
    ...
    var h,
      ...
      u = function (t, e, n, r, s) {
        ...
        if (n && "object" == typeof n) {
          void 0 !== r && "context" in s && void 0 === s.context &&
            (s.context = r);
    ...
    i.extend(
      ...
      a,
      {
        ...
        get: function (t) {
          if (null != t) {
            return this._byId[t] || this._byId[this.modelId(
              this._isModel(t)
                ? t.attributes
                : t,
        ...
        _prepareModel: function (t, e) {
          ...
          return n.validationError
            ? (this.trigger("invalid", this, n.validationError, e), !1) : n;
        },
    ...
    e.version = "2.3.7",
      ...
      e.FieldRef.prototype.toString = function () {
        return null == this._stringValue &&
          (this._stringValue = this.fieldName + e.FieldRef.joiner +
            this.docRef),
          this._stringValue;
      },
      e.Set = function (e) {
      ...
      e.TokenSet.Builder.prototype.insert = function (t) {
        var r, i = 0;
        if (t < this.previousWord) {throw new Error(
            "Out of order word insertion",
          );}
        for (
          var n = 0;
      ...
      e.Index.prototype.query = function (t) {
        ...
        for (u = 0; u < r.clauses.length; u++) {
          ...
          c = l.usePipeline
            ? this.pipeline.runString(l.term, { fields: l.fields }) : [l.term];
                ...
                if (
                  ...
                  if (
                    ...
                    for (var b = 0; b < S.length; b++) {
                      ...
                      void 0 === (P = i[O]) ? i[O] = new e.MatchData(x, v, I)
                      : P.add(x, v, I);
                    }
                    s[E] = !0;
                  }
      ...
      e.QueryLexer.lexText = function (t) {
        for (;;) {
          ...
          if (92 != r.charCodeAt(0)) {
            ...
            if (r.match(e.QueryLexer.termSeparator)) {return e.QueryLexer
                .lexTerm;}
