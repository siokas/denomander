!function (e, t) {
  ...
  var h = function (n) {
    ...
    function se(t, e, n, r) {
      ...
      if (!r && ((e ? e.ownerDocument || e : m) !== C && T(e), e = e || C, E)) {
        if (11 !== p && (u = Z.exec(t))) {
          if (i = u[1]) {
            if (9 === p) {
              ...
              f && (a = f.getElementById(i)) && y(e, a) && a.id === i
            ) {
              return n.push(a), n;
            }
          } else {
            ...
            if (
              (i = u[3]) && d.getElementsByClassName && e.getElementsByClassName
            ) {
        ...
        if (
          d.qsa && !A[t + " "] && (!v || !v.test(t)) &&
          (1 !== p || "object" !== e.nodeName.toLowerCase())
        ) {
          if (c = t, f = e, 1 === p && U.test(t)) {
            for ((s = e.getAttribute("id"))
              ? s = s.replace(re, ie)
              : e.setAttribute("id", s = k), o = (l = h(t)).length; o--;) {
              l[o] = "#" + s + " " + xe(l[o]);
            }
            ...
            (a = (C = r).documentElement,
              ...
              d.getById
                ...
                : (b.filter.ID = function (e) {
                  ...
                  return function (e) {
                    var t = void 0 !== e.getAttributeNode &&
                  ...
                  if (void 0 !== t.getElementById && E) {
                    ...
                    if (o) {
                      if (
                        (n = o.getAttributeNode("id")) && n.value === e
                      ) {
                        return [o];
                      }
                  ...
                  return n ||
                    (1 &
                      ...
                      ? e === C || e.ownerDocument === m && y(m, e)
                        ? -1
                        : t === C || t.ownerDocument === m && y(m, t) ? 1 : u
                          ? P(u, e) - P(u, t)
                          : 0
                      : 4 & n ? -1 : 1);
                }
        ...
        se.matchesSelector = function (e, t) {
          if (
            (e.ownerDocument || e) !== C && T(e),
              d.matchesSelector && E && !A[t + " "] && (!s || !s.test(t)) &&
                (!v || !v.test(t))
          ) {
            try {
              var n = c.call(e, t);
              if (
                n || d.disconnectedMatch || e.document &&
              ...
              : function (e, t, n) {
                ...
                if (c) {
                  ...
                  if (u = [m ? c.firstChild : c.lastChild], m && p) {
                    ...
                    p &&
                      (d = s =
                        (r = (i = (o = (a = e)[k] || (a[k] = {}))[a.uniqueID] ||
                          (o[a.uniqueID] = {}))[h] || [])[0] === S && r[1]),
                      !1 === d
                  ) {
                    for (
                      ;
                      (a = ++s && a && a[l] || (d = s = 0) || u.pop()) && ((x
          ...
          if (n) {
            ...
            for (; e = e[u];) {
              if (
                ...
                if (
                  i = (o = e[k] || (e[k] = {}))[e.uniqueID] ||
                    (o[e.uniqueID] = {}), l && l === e.nodeName.toLowerCase()
                ) {
                  e = e[u] || e;
                } else {
    ...
    return me.prototype = b.filters = b.pseudos,
      ...
      g = se.select = function (e, t, n, r) {
        ...
        if (n = n || [], 1 === c.length) {
          if (
            2 < (o = c[0] = c[0].slice(0)).length && "ID" === (a = o[0]).type &&
          ...
          for (i = G.needsContext.test(e)
            ? 0
            : o.length; i-- && (a = o[i], !b.relative[s = a.type]);) {
            if (
              (u = b.find[s]) &&
              (r = u(
    ...
    if (r[1]) {
      if (
        t = t instanceof k ? t[0] : t,
          k.merge(this, k.parseHTML(r[1], t && t.nodeType
            ? t.ownerDocument || t
            : E, !0)),
  ...
  k.Callbacks = function (r) {
    var e, n;
    r = "string" == typeof r
      ? (e = r, n = {}, k.each(e.match(R) || [], function (e, t) {
        n[t] = !0;
      }), n)
      : k.extend({}, r);
    function c() {
    ...
    var i, t, o, a, s = [], u = [], l = -1, f = { add: function () {
          ...
          var n = this, r = arguments, e = function () {
            ...
            try {
              ...
              k.Deferred.exceptionHook &&
                k.Deferred.exceptionHook(e, t.stackTrace), u <= i + 1 &&
  ...
  k.fn.ready = function (e) {
    ...
    k.extend({ isReady: !1, readyWait: 1, ready: function (e) {
      (!0 === e ? --k.readyWait : k.isReady) || (k.isReady = !0) !== e &&
        0 < --k.readyWait || F.resolveWith(E, [k]);
    } }),
    k.ready.then = F.then,
    "complete" === E.readyState || "loading" !== E.readyState &&
  ...
  k.extend({ hasData: function (e) {
    ...
    var n = t + "queueHooks";
    return Q.get(e, n) ||
      Q.access(e, n, { empty: k.Callbacks("once memory").add(function () {
  ...
  function De(e, i, o) {
    o
      ? (Q.set(e, i, !1),
        k.event.add(e, i, { namespace: !1, handler: function (e) {
  ...
  k.event = { global: {}, add: function (t, e, n, r, i) {
        ...
        if (
          ...
          for (f = k.event.special[d] || {},
            ...
            s = s[2] &&
              new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"),
            a = o = p.length; o--;) {
            c = p[o], !i && g !== c.origType || n && n.guid !== c.guid || s &&
    ...
    Object.defineProperty(
      k.Event.prototype,
      t,
      { enumerable: !0, configurable: !0, get: m(e)
        ? function () {
    ...
    var t = e.target;
    return pe.test(t.type) && t.click && A(t, "input") && Q.get(t, "click") ||
      A(t, "a");
  ...
  function Ie(n, r, i, o) {
    ...
    if (
      h || 1 < f && "string" == typeof d && !y.checkClone && Le.test(d)
    ) {
  ...
  k.extend({ htmlPrefilter: function (e) {
    ...
    if (
      !(y.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType ||
        k.isXMLDoc(e))
    ) {
  ...
  !function () {
    ...
    u.style &&
      (u.style.backgroundClip = "content-box",
        ...
        k.extend(y, { boxSizingReliable: function () {
          return e(), r;
  ...
  function tt(e, t, n) {
    ...
    return (!y.boxSizingReliable() && i || "auto" === a || !parseFloat(a) &&
      ...
      (i = "border-box" === k.css(e, "boxSizing", !1, r),
        (o = s in e) && (a = e[s])), (a = parseFloat(a) || 0) + et(e, t, n || (i
          ? "border"
          : "content"), o, r, a) + "px";
  }
  ...
  k.extend({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        "string" == (o = typeof n) && (i = ne.exec(n)) && i[1] &&
          (n = le(e, t, i), o = "number"), null != n && n == n &&
          ("number" !== o || u || (n += i && i[3] || (k.cssNumber[s]
            ? ""
            : "px")),
            y.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") ||
              (l[t] = "inherit"),
            a && "set" in a && void 0 === (n = a.set(e, n, r)) || (u
              ? l.setProperty(t, n)
              : l[t] = n));
      }
    },
    ...
    (nt.propHooks = { _default: { get: function (e) {
      var t;
  ...
  function dt(o, e, t) {
    ...
    for (function (e, t) {
      ...
      if (
        n = dt.prefilters[r].call(l, o, c, l.opts)
      ) {
        return m(n.stop) &&
  ...
  k.Animation = k.extend(dt, { tweeners: { "*": [function (e, t) {
    ...
    if ((u = !k.isEmptyObject(t)) || !k.isEmptyObject(d)) {
      for (
        r in f && 1 === e.nodeType &&
          (n.overflow = [h.overflow, h.overflowX, h.overflowY],
            ...
            ("inline" === c || "inline-block" === c && null != l) &&
              "none" === k.css(e, "float") && (u || (p.done(function () {
                h.display = l;
        ...
        u || (v
          ...
          p.done(function () {
            for (
              r in g || fe([e]), Q.remove(e, "fxshow"), d
            ) {
              k.style(e, r, d[r]);
            }
          })),
    ...
    k.speed = function (e, t, n) {
      ...
      return k.fx.off
        ? r.duration = 0
        : "number" != typeof r.duration && (r.duration in k.fx.speeds
  ...
  k.fn.extend({ attr: function (e, t) {
    ...
    if (3 !== o && 8 !== o && 2 !== o) {
      return void 0 === e.getAttribute
        ? k.prop(e, t, n)
        : (1 === o && k.isXMLDoc(e) ||
          (i = k.attrHooks[t.toLowerCase()] || (k.expr.match.bool.test(t)
            ? ht
            : void 0)), void 0 !== n
          ? null === n
    ...
    gt[t] = function (e, t, n) {
      ...
      return n || (i = gt[o], gt[o] = r, r = null != a(e, t, n)
        ? o
        : null, gt[o] = i), r;
    };
  });
  ...
  k.fn.extend({ prop: function (e, t) {
    ...
    y.optSelected || (k.propHooks.selected = { get: function (e) {
      var t = e.parentNode;
    ...
    k.fn.extend({ addClass: function (t) {
            ...
            if (a) {
              ...
              void 0 !== i && "boolean" != o ||
                ((e = xt(this)) && Q.set(this, "__className__", e),
                  this.setAttribute && this.setAttribute("class", e || !1 === i
                    ? ""
      ...
      for (t = " " + e + " "; n = this[r++];) {
        if (
          1 === n.nodeType && -1 < (" " + mt(xt(n)) + " ").indexOf(t)
        ) {
          return !0;
        }
      }
        ...
        1 === this.nodeType && (null == (t = i
          ...
          : "number" == typeof t
            ...
            : Array.isArray(t) && (t = k.map(t, function (e) {
              ...
              k.valHooks[this.nodeName.toLowerCase()]) && "set" in r &&
  ...
  k.extend(k.event, { trigger: function (e, t, n, r) {
    var i, o, a, s, u, l, c, f, p = [n || E], d = v.call(e, "type")
      ? e.type
      : e, h = v.call(e, "namespace")
        ? e.namespace.split(".")
        : [];
    if (
      o = f = a = n = n || E, 3 !== n.nodeType && 8 !== n.nodeType &&
      ...
      return e.type = d, r || e.isDefaultPrevented() || c._default &&
        !1 !== c._default.apply(p.pop(), t) || !G(n) || u && m(n[d]) &&
        !x(n) &&
        ((a = n[u]) && (n[u] = null),
          k.event.triggered = d,
  ...
  Ft.href = Et.href, k.extend(
    {
      ...
      ajax: function (e, t) {
        ...
        for (
          i in (g = k.event && v.global) && 0 == k.active++ &&
            ...
            v.hasContent
              ...
              : (o = v.url.slice(f.length),
                ...
                !1 === v.cache && (f = f.replace(Ot, "$1"), o = (St.test(f)
                  ? "&"
                  : "?") + "_=" + kt++ + o),
                v.url = f + o),
            v.ifModified &&
        ...
        if (
          v.beforeSend && (!1 === v.beforeSend.call(y, T, v) || h)
        ) {
          return T.abort();
        }
        if (
    ...
    k.ajaxTransport(function (i) {
      ...
      if (y.cors || Xt && !i.crossDomain) {
        return { send: function (e, t) {
          ...
          for (
            n in i.mimeType && r.overrideMimeType &&
          ...
          o = function (e) {
            return function () {
              o &&
                (o = a = r.onload = r.onerror = r.onabort = r.ontimeout = r
                  .onreadystatechange = null, "abort" === e
                  ? r.abort()
                  : "error" === e
  ...
  k.ajaxSetup({ jsonp: "callback", jsonpCallback: function () {
    ...
    k.ajaxPrefilter("json jsonp", function (e, t, n) {
      var r, i, o, a = !1 !== e.jsonp && (Yt.test(e.url)
        ? "url"
    ...
    y.createHTMLDocument =
      ((Vt = E.implementation.createHTMLDocument("").body).innerHTML =
        "<form></form><form></form>", 2 === Vt.childNodes.length),
    ...
    k.fn.load = function (e, t, n) {
      ...
      return -1 < s && (r = mt(e.slice(s)), e = e.slice(0, s)), m(t)
        ...
        k.ajax({ url: e, type: i || "GET", dataType: "html", data: t }).done(
          function (e) {
    ...
    k.offset = { setOffset: function (e, t, n) {
      ...
      "static" === l && (e.style.position = "relative"),
        ...
        o = k.css(e, "top"),
        u = k.css(e, "left"),
        i = ("absolute" === l || "fixed" === l) && -1 < (o + u).indexOf("auto")
  ...
  var n = "object" == typeof self && self.self === self && self ||
    "object" == typeof global && global.global === global && global || this ||
    {},
    r = n._,
    e = Array.prototype,
    o = Object.prototype,
    ...
    h = function (n) {
      return n instanceof h
        ? n
        : this instanceof h ? void (this._wrapped = n) : new h(n);
    };
  "undefined" == typeof exports || exports.nodeType
    ? n._ = h
    : ("undefined" != typeof module && !module.nodeType && module.exports &&
  ...
  function d(n, r, t) {
    return h.iteratee !== v
      ? h.iteratee(n, r)
      : null == n ? h.identity : h.isFunction(n)
        ? y(n, r, t)
        : h.isObject(n) && !h.isArray(n) ? h.matcher(n) : h.property(n);
  }
  var v;
  ...
  var _ = Math.pow(2, 53) - 1, A = b("length");
  ...
  h.reduce = h.foldl = h.inject = O(1),
    ...
    h.max = function (n, e, r) {
      var t, u, i = -1 / 0, o = -1 / 0;
      if (
        null == e || "number" == typeof e && "object" != typeof n[0] &&
        null != n
      ) {
        for (
  ...
  h.toArray = function (n) {
    return n
      ? h.isArray(n)
        ? c.call(n)
        : h.isString(n) ? n.match(S) : w(n) ? h.map(n, h.identity) : h.values(n)
      : [];
  }, h.size = function (n) {
    ...
    return null == n || n.length < 1
      ? null == r ? void 0 : []
      : null == r || t ? n[0] : h.initial(n, n.length - r);
  }, h.initial = function (n, r, t) {
    return c.call(n, 0, Math.max(0, n.length - (null == r || t ? 1 : r)));
  }, h.last = function (n, r, t) {
    return null == n || n.length < 1
      ? null == r ? void 0 : []
      : null == r || t ? n[n.length - 1] : h.rest(n, Math.max(0, n.length - r));
  ...
  h.pick = g(function (n, r) {
    ...
    return h.isFunction(e)
      ...
      : (t = h.map(M(t, !1, !1), String), e = function (n, r) {
    ...
    if (!i) {
      ...
      if (
        o !== a &&
        !(h.isFunction(o) && o instanceof o && h.isFunction(a) &&
          a instanceof a) && "constructor" in n && "constructor" in r
      ) {
        return !1;
      }
    }
  ...
  "function" != typeof /./ && "object" != typeof Int8Array &&
    "function" != typeof D && (h.isFunction = function (n) {
  ...
  var e = "object" == typeof self && self.self === self && self ||
  ...
  var r = t.Backbone, s = Array.prototype.slice;
  e.VERSION = "1.4.0", e.$ = n, e.noConflict = function () {
    return t.Backbone = r, this;
  }, e.emulateHTTP = !1, e.emulateJSON = !1;
  var h, a = e.Events = {}, o = /\s+/, u = function (t, e, n, r, s) {
    var h, a = 0;
  ...
  a.on = function (t, e, i) {
    this._events = u(
      ...
      t,
      e,
      { context: i, ctx: this, listening: h },
    ), h &&
  ...
  var l = function (t, e, i, n) {
    if (i) {
      var r = t[e] || (t[e] = []), s = n.context, a = n.ctx, o = n.listening;
      o && o.count++,
  ...
  a.off = function (t, e, i) {
    return this._events &&
      (this._events = u(
        ...
        t,
        e,
        { context: i, listeners: this._listeners },
      )), this;
  ...
  var f = function (t, e, n, r) {
    if (t) {
      var h, s = r.context, a = r.listeners, o = 0;
      if (e || s || n) {
        for (h = e ? [e] : i.keys(t); o < h.length; o++) {
          ...
          for (var l = [], c = 0; c < u.length; c++) {
            var f = u[c];
            if (
              n && n !== f.callback && n !== f.callback._callback || s &&
              s !== f.context
            ) {
              l.push(f);
            } else {
  ...
  g.prototype.on = a.on, g.prototype.off = function (t, e) {
    (this.interop
      ? (this._events = u(
        ...
        t,
        e,
        { context: void 0, listeners: void 0 },
      ), this._events)
  ...
  i.extend(
    ...
    a,
    {
      ...
      set: function (t, e, n) {
        ...
        var s = n.unset, a = n.silent, o = [], h = this._changing;
        this._changing = !0, h ||
          (this._previousAttributes = i.clone(this.attributes),
            this.changed = {});
        var u = this.attributes, l = this.changed, c = this._previousAttributes;
        for (var f in r) {
          e = r[f],
      ...
      destroy: function (t) {
        ...
        return this.isNew()
          ? i.defer(t.success)
          : (G(this, t), a = this.sync("delete", this, t)), r || s(), a;
      },
      url: function () {
        var t = i.result(this, "urlRoot") || i.result(this.collection, "url") ||
          V();
  ...
  function x(t, e, i) {
    ...
    var s, n = Array(t.length - i), r = e.length;
  ...
  }, y = { add: !0, remove: !0, merge: !0 }, b = { add: !0, remove: !1 };
  i.extend(
    _.prototype,
    a,
    {
        ...
        if (null != t) {
          ...
          for (m = 0; m < t.length; m++) {
            ...
            if (_) {
              ...
              l && (g = t[m] = this._prepareModel(g, e)) &&
          ...
          if (
            s.length && E
              ...
              : a.length && (v && (d = !0), x(this.models, a, null == r
                ? this.length
                : r), this.length = this.models.length),
      ...
      get: function (t) {
        if (null != t) {
          return this._byId[t] || this._byId[this.modelId(this._isModel(t)
            ? t.attributes
            : t)] || t.cid && this._byId[t.cid];
        }
      },
      has: function (t) {
        return null != this.get(t);
      ...
      fetch: function (t) {
        var e = (t = i.extend({ parse: !0 }, t)).success, n = this;
        return t.success = function (i) {
  ...
  var C = function (t, e) {
    return i.isFunction(t)
      ? t
      : i.isObject(t) && !e._isModel(t) ? R(t) : i.isString(t)
        ? function (e) {
          return e.get(t);
        }
        : t;
  ...
  i.each(
    ...
    i.defaults(
      r || (r = {}),
      { emulateHTTP: e.emulateHTTP, emulateJSON: e.emulateJSON },
    );
    var a = { type: s, dataType: "json" };
    if (
      r.url || (a.url = i.result(n, "url") || V()),
        null != r.data || !n || "create" !== t && "update" !== t &&
          "patch" !== t ||
          (a.contentType = "application/json",
            a.data = JSON.stringify(r.attrs || n.toJSON(r))),
        r.emulateJSON &&
          (a.contentType = "application/x-www-form-urlencoded", a.data = a.data
            ? { model: a.data }
            : {}),
  ...
  i.extend(
    ...
    a,
    {
      ...
      _routeToRegExp: function (t) {
        return t = t.replace(F, "\\$&").replace(U, "(?:$1)?").replace(
          z,
          function (t, e) {
            return e ? t : "([^/?]+)";
          },
  ...
  B.started = !1, i.extend(B.prototype, a, { interval: 50, atRoot: function () {
    return this.location.pathname.replace(/[^\/]$/, "$&/") === this.root &&
      !this.getSearch();
  }, matchRoot: function () {
    return this.decodeFragment(this.location.pathname).slice(
      0,
      this.root.length - 1,
    ) + "/" === this.root;
    ...
    var t = this.decodeFragment(this.location.pathname + this.getSearch())
      .slice(this.root.length - 1);
    return "/" === t.charAt(0) ? t.slice(1) : t;
  }, getFragment: function (t) {
    return null == t && (t = this._usePushState || !this._wantsHashChange
      ? this.getPath()
      : this.getHash()), t.replace(J, "");
  }, start: function (t) {
    ...
    if (
      ...
      this._hasPushState && this.atRoot() &&
    ...
    if (
      e === this.fragment && this.iframe &&
        (e = this.getHash(this.iframe.contentWindow)), e === this.fragment
    ) {
      return !1;
    }
  ...
  e.version = "2.3.7",
    ...
    e.Set.complete = { intersect: function (e) {
      return e;
    }, union: function (e) {
      return e;
    }, contains: function () {
    ...
    e.Set.empty = { intersect: function () {
      return this;
    }, union: function (e) {
      return e;
    }, contains: function () {
      ...
      var e = {
        ...
        I = function (r) {
          ...
          if (
            ...
            i = (I = a.exec(r))[1],
              (a = f).test(i) && (u = w, l = Q, (a = x).test(r = i)
                ? r += "e"
                : u.test(r)
                  ? (o = g, r = r.replace(o, ""))
                  : l.test(r) && (r += "e"));
    ...
    e.TokenSet.fromFuzzyString = function (t, r) {
      for (
        ...
        if (0 != s.editsRemaining) {
          ...
          if (
            0 == s.str.length && (u.final = !0), n.push(
    ...
    e.TokenSet.Builder.prototype.insert = function (t) {
      ...
      this.minimize(i), r = 0 == this.uncheckedNodes.length
        ? this.root
      ...
      for (
        ...
        for (
          ...
          void 0 === n[x]
            ...
            v = m * ((this._k1 + 1) * w) /
              (this._k1 *
                (1 - this._b + this._b * (u / this.averageFieldLength[a])) + w),
            v *= f,
            v *= p,
    ...
    e.MatchData = function (e, t, r) {
      ...
      this.metadata = Object.create(null), void 0 !== e &&
    ...
    e.Query.prototype.isNegated = function () {
      for (var t = 0; t < this.clauses.length; t++) {
        if (
          this.clauses[t].presence != e.Query.presence.PROHIBITED
        ) {
          return !1;
        }
      }
...
var __extends = this && this.__extends || function () {
  ...
  return function (d, b) {
    ...
    extendStatics(d, b), d.prototype = null === b
      ? Object.create(b)
...
!function (typedoc) {
  ...
  var Application = function (_super) {
    function Application() {
      ...
      return _this.createServices(),
        _this.createComponents(typedoc.$body),
        _this;
    }
    return __extends(Application, _super),
  ...
  var Viewport = function (_super) {
    function Viewport() {
      ...
      return _this.scrollTop = 0,
        ...
        typedoc.$window.on("scroll", _.throttle(function () {
          return _this.onScroll();
        }, 10)),
        typedoc.$window.on("resize", _.throttle(function () {
  ...
  typedoc.pointerDown = "mousedown",
    ...
    typedoc.$document.on(typedoc.pointerDown, function (e) {
      ...
      var t = "touchstart" == typedoc.pointerDown
  ...
  var FilterItem = function () {
    ...
    return __extends(FilterItemCheckbox, _super),
      ...
      FilterItemCheckbox.prototype.handleValueChange = function (
        ...
        this.$checkbox.prop("checked", this.value), typedoc.$html.toggleClass(
          "toggle-" + this.key,
      ...
      FilterItemSelect.prototype.handleValueChange = function (
        ...
        this.$select.find("li.selected").removeClass("selected"),
          this.$select.find(".tsd-select-label").text(
            this.$select.find('li[data-value="' + newValue + '"]').addClass(
              "selected",
            ).text(),
          ),
        ...
        -1 != base.indexOf("#") && (base = base.substr(0, base.indexOf("#"))),
          this.$el.find("a").each(function (_index, el) {
            ...
            if (
              ...
              0 != $anchor.length &&
                _this.anchors.push(
                  { $link: $(el.parentNode), $anchor: $anchor, position: 0 },
                );
            }
          }),
          this.onResize();
  ...
  !function (search) {
    ...
    function createIndex() {
      ...
      !function batch() {
        for (var cycles = 0; cycles++ < 100;) {
          if (
            builder.add(rows[pos]), ++pos == length
          ) {
      ...
      if ($results.empty(), loadingState == SearchLoadingState.Ready && query) {
        ...
        for (var i = 0, c = Math.min(10, res.length); i < c; i++) {
          ...
          (parent = parent.replace(new RegExp(query, "i"), function (match) {
            ...
            $results.append(
              '<li class="' + row.classes + '"><a href="' + base + row.url +
                '" class="tsd-kind-icon">' + name + "</li>",
            );
        }
      }
    }
    ...
    function setHasFocus(value) {
      hasFocus != value &&
        (hasFocus = value, $el.toggleClass("has-focus"), value
          ? (setQuery(""), $field.val(""))
          : $field.val(query));
    }
    ...
    function setCurrentResult(dir) {
      ...
      if (0 == $current.length) {
        $results.find(1 == dir ? "li:first-child" : "li:last-child").addClass(
          "current",
        );
      } else {
    ...
    $results.on("mousedown", function () {
      ...
      13 == e.keyCode || 27 == e.keyCode || 38 == e.keyCode || 40 == e.keyCode
        ? (preventPress = !0,
          e.preventDefault(),
          13 == e.keyCode ? gotoCurrentResult() : 27 == e.keyCode
            ? $field.blur()
            : 38 == e.keyCode
              ? setCurrentResult(-1)
      ...
      e.altKey || e.ctrlKey || e.metaKey || !hasFocus && 47 < e.keyCode &&
        e.keyCode < 112 && $field.focus();
    });
  ...
  typedoc.transition = function (tuples) {
    for (var name in tuples) {
      if (
        tuples.hasOwnProperty(name) && void 0 !== document.body.style[name]
      ) {
  ...
  var SignatureGroup = function () {
    ...
    return SignatureGroup.prototype.addClass = function (className) {
      return this.$signature.addClass(className),
        this.$description.addClass(className),
        this;
    }, SignatureGroup.prototype.removeClass = function (className) {
      return this.$signature.removeClass(className),
      ...
      return _this.groups = [],
        ...
        _this.$container &&
          (_this.$el.addClass("active").on(
            ...
            return _this.onClick(event);
          }), _this.$container.addClass("active"), _this.setIndex(0)),
        _this;
    }
  ...
  var Toggle = function (_super) {
    function Toggle(options) {
      var _this = _super.call(this, options) || this;
      return _this.className = _this.$el.attr("data-toggle") || "",
