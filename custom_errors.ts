...
export const VALIDATION_INVALID_RULE: Error = new DenomanderError(
  DenomanderError.getErrorMessages().INVALID_RULE,
);
export const VALIDATION_OPTION_NOT_FOUND: Error = new DenomanderError(
  DenomanderError.getErrorMessages().OPTION_NOT_FOUND,
);
export const VALIDATION_COMMAND_NOT_FOUND: Error = new DenomanderError(
  DenomanderError.getErrorMessages().COMMAND_NOT_FOUND,
);
export const VALIDATION_REQUIRED_OPTIONS_NOT_FOUND: Error = new DenomanderError(
  DenomanderError.getErrorMessages().REQUIRED_OPTION_NOT_FOUND,
);
export const VALIDATION_REQUIRED_VALUE_NOT_FOUND: Error = new DenomanderError(
